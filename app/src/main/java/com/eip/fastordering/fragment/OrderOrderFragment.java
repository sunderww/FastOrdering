        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    //TODO FORCED ORDER FOR ALEXIS TO TEST OPTIONS

                    JSONObject option = new JSONObject();
                    option.put("id", "5639252b7cf3ddd0bee7574b");
                    option.put("qty", "2");
                    ...
                    dish = new JSONObject();
                    dish.put("id", "55c39d0912ac3eb54d51a541");
                    dish.put("qty", "2");
                    dish.put("comment", "plat avec option");
                    dish.put("options", arrOptions);
                    ...
                    orderJSON.put("numTable", "123");
                    orderJSON.put("numPA", "2");
                    orderJSON.put("globalComment", "Avec options");
                    orderJSON.put("order", arrMenus);
